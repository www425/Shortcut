...
def init_wandb(args):
    name_of_project = "adult DFL Testing"
...
def __main__():
    ...
    if args.no_finetuning:
        ...
        data = FinetuningData(f"../data/adult/tokens_{args.model}_128.pt",
                              args.seed, args.split, args.testing_balanced, args.few_shot)

    model, checkpoint_folder = get_model(args.no_finetuning, data.n_labels, "../checkpoints/adult", args.model,
